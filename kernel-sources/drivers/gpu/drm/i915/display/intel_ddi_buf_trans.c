...
static const union intel_ddi_buf_trans_entry _ehl_combo_phy_ddi_translations_dp[] = {
	...
	{ .cnl = { 0xA, 0x47, 0x38, 0x00, 0x07 } },	/* 350   500      3.1   */
	{ .cnl = { 0xC, 0x64, 0x33, 0x00, 0x0C } },	/* 350   700      6.0   */
	{ .cnl = { 0x6, 0x7F, 0x2F, 0x00, 0x10 } },	/* 350   900      8.2   */
	{ .cnl = { 0xA, 0x46, 0x3F, 0x00, 0x00 } },	/* 500   500      0.0   */
	{ .cnl = { 0xC, 0x64, 0x37, 0x00, 0x08 } },	/* 500   700      2.9   */
