 ...
 */
int map_winctx_mmio_bars(struct pnv_vas_window *window)
{
	int len;
	u64 start;
 ...
 */
void reset_window_regs(struct pnv_vas_window *window)
{
 ...
 */
int init_winctx_regs(struct pnv_vas_window *window, struct vas_winctx *winctx)
{
	u64 val;
	int fifo_size;
