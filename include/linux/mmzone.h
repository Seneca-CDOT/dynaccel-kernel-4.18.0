...
enum node_stat_item {
	...
	NR_SHMEM_THPS,
	NR_SHMEM_PMDMAPPED,
	RH_KABI_BROKEN_INSERT_ENUM(NR_FILE_THPS)
	RH_KABI_BROKEN_INSERT_ENUM(NR_FILE_PMDMAPPED)
	NR_ANON_THPS,
	RH_KABI_BROKEN_REMOVE_ENUM(NR_UNSTABLE_NFS)
	NR_VMSCAN_WRITE,
...
struct zone {
	...
	unsigned long RH_KABI_RENAME(watermark, _watermark)[NR_WMARK];
